...
Vagrant::Config.run do |config|
  ...
  config.vm.box = "win7-enterprise64"
  ...
  # the file win7-enterprise64.pp in the manifests_path directory.
  #
  ...
  #   puppet.manifest_file  = "win7-enterprise64.pp"
  # end
  ...
  config.vm.provision :chef_solo do |chef|
    ...
    chef.add_recipe "jaws"
    chef.add_recipe "crossbrowser"
